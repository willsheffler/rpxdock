...
from sicdock.search.dockspec import DockSpec2CompCage
...
if __name__ == "__main__":
   ...
   pose1 = get_pose_cached("sicdock/data/pdb/C3_1nza_1.pdb.gz")
   pose2 = get_pose_cached("sicdock/data/pdb/C2_3hm4_1.pdb.gz")
