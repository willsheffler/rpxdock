...
def test_body(C2_3hm4, C3_1wa3, sym1=2, sym2=3):
   body1 = Body(C2_3hm4, sym1)
   body2 = Body(C3_1wa3, sym2)
   print(body2.nres)
...
def test_body_pickle(C3, tmpdir):
   b = Body(C3)
...
if __name__ == "__main__":
   ...
   test_body_pickle(f2, '/home/cnfries/PycharmProjects/rpxdock-cnfries/rpxdock/data/pdb')

   #b = rp.data.get_body('1wa3_renum')
