...
def test_inputs():
    ...
    kw = defaults(process_args=False).sub(
        ...
        inputs2=['foo2', 'bar2'],
        allowed_residues2=['xfoo2', 'xbar2'],
        inputs3=['foo3', 'bar3'],
        allowed_residues3=['xfoo3', 'xbar3'],
    )
    kw = process_cli_args(kw, read_allowed_res_files=False)
...
def test_parse_termini():
    kw = defaults(process_args=False).sub(inputs1=['foo', 'bar'],
                                          inputs2=['foo'],
                                          inputs3=['foo', 'bar'],
    ...
    kw = defaults(process_args=False).sub(inputs1=['foo'],
                                          inputs2=['foo', 'bar'],
...
def test_dir_plus_bool():
    ...
    assert (dir_plus_bool(['t', 'f', 'no', 'yes', '1', '0']) == [True, False, False, True, True, False])
