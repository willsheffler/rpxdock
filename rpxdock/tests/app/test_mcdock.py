...
def main():
   test_mcdock_compframes()

def test_mcdock_compframes():
   sym = 'I 21 3'
   ...
   samp = wu.Bunch(
      position=np.array([[[0.31607197, -0.52750669, -0.78856528, 11.92298762],
                          [-0.52750669, -0.78856528, 0.31607197, 11.92298762],
                          [-0.78856528, 0.31607197, -0.52750669, 99.53378063], [0., 0., 0., 1.]]]),
   ...
   ic(debug)
   ic(compcoms)
   wu.dumppdb(f'/home/sheffler/project/rpxtal/orig.pdb', debug, frames=np.eye(4))
