...
def test_plug_olig_hier(hscore, body_c3_mono, hole):
   ...
   result = make_plugs(body_c3_mono, hole, hscore, hsamp, search=rp.hier_search, **arg)
...
def test_plug_olig_grid(hscore, body_c3_mono, hole):
   ...
   result = make_plugs(body_c3_mono, hole, hscore, xgrid, search=rp.grid_search, **arg)
...
if __name__ == "__main__":
   ...
   hole = rp.data.body_small_c3_hole()
   plug = rp.data.body_dhr64()
   body_c3_mono = rp.data.body_c3_mono()
