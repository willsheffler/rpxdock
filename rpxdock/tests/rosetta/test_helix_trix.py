...
def test_termini_direction(poses_list_helices):
   actual_dirs = [[True, True], [False, False],
                  [True, False]]  #based on input; change in input is changed!
...
def test_limit_flip_update():
   ...
   kw.termini_dir = [[[None, None]], [[True, False]], [[False, True], [True, False]],
                     [[False, False]]]
...
def test_init_termini(mixed_inputs, helix):
   ...
   kw.termini_dir = [[[None, None]], [[True, True]], [[False, False]], [[True, False]],
                     [[None, None]], [[True, False]]]
   kw.term_access = [[[False, False]], [[False, False]], [[True, False]], [[False, True]],
