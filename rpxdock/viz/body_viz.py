...
if 'pymol' in sys.modules:
    ...
    def pymol_load_Body(
        ...
        **kw,
        ...
        # ic(coord.shape)
        wu.viz.show_ndarray_n_ca_c(coord, name=name + "_bbone")
        # wu.viz.show_ndarray_line_strip(coord,
        # state=state,
        # name=name + '_bbone',
        # breaks=breaks,
        # breaks_groups=breaks_groups,
        # **kw)
        ...
        if showframes:
            wu.viz.pymol_visualize_xforms(body.symcom(pos),
                                          state,
                                          name=name + '_frames',
                                          scale=1,
                                          weight=3,
