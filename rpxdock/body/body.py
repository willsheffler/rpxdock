...
class Body:
    ...
    def set_pose_info(self, source, sym, extract_chain=None, use_rosetta=True, **kw):
        ...
        if pose.pdb_info() is not None:
            ...
            if ci is not None:
                self.crystinfo = wu.Bunch(spacegroup=ci.spacegroup(),
                                          cell=[ci.A(), ci.B(), ci.C()],
    ...
    def intersect_range(self,
      ...
      '''
        ...
        trim = rp.bvh.isect_range(self.bvh_bb,
                                  other.bvh_bb,
                                  xself,
                                  xother,
                                  mindis,
    ...
    def contact_pairs(self, other, pos1=None, pos2=None, maxdis=10, buf=None, use_bb=False, atomno=False):
        ...
        pairs, overflow = rp.bvh.bvh_collect_pairs(
            ...
            other.bvh_bb_atomno if atomno else (other.bvh_bb if use_bb else other.bvh_cen), pos1, pos2, maxdis,
            buf)
        assert not overflow
        return pairs
